...
const income_testSchema = require("../../../schema/Pension/income_test/income_test");
...
MyRouter.patch("/Update/:id", async (req, res) => {
  const Updateincome_test = await income_testDetails.findOne({ _id: req.params.id });
    ...
    Updateincome_test.income_full_pension = req.body.income_full_pension,
    Updateincome_test.income_part_pension = req.body.income_part_pension,
    Updateincome_test.reduction_factor = req.body.reduction_factor
