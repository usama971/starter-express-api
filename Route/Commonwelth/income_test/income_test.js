...
const income_testDetails = require("../../../Model/Commonwelth/income_test/income_test");
const income_testSchema = require("../../../schema/Commonwelth/income_test/income_test");
...
MyRouter.patch("/Update/:id", async (req, res) => {
  const Updateincome_test = await income_testDetails.findOne({ _id: req.params.id });
    ...
    Updateincome_test.annual_income = req.body.annual_income
